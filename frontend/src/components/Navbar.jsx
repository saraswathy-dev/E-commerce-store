    ...
    <>
      <header className="fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-gray-800 ">
        <div className="container mx-auto px-2 py-4 flex justify-between items-center   ">
          <Link
            to="/"
            className="text-2xl font-bold text-white-800 items-center space-x-2 flex hover:text-blue-300 transition-colors duration-300"
          >
            E-Commerce
          </Link>
          <nav className="flex items-center  space-x-4">
            ...
            {user ? (
              <button className="bg-gray-500 text-white px-2 py-2 rounded-md hover:bg-gray-700 transition-colors duration-300 flex items-center">
